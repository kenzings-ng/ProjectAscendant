...
namespace
{
	constexpr float kPartTolerance = 0.05f;
}
...
bool FPAPartBreakingTests::RunTest(const FString& Parameters)
{
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC1: Horn Max HP is 2,000"), Model.GetPartHealth(EPABossPartType::Horn), 2000.0f, kPartTolerance);
		TestNearlyEqual(TEXT("AC1: Tail Max HP is 1,500"), Model.GetPartHealth(EPABossPartType::Tail), 1500.0f, kPartTolerance);
		TestNearlyEqual(TEXT("AC1: Chest Armor Max HP is 2,500"), Model.GetPartHealth(EPABossPartType::ChestArmor), 2500.0f, kPartTolerance);
		...
		TestNearlyEqual(TEXT("AC1: Horn HP reduced to 1500"), Model.GetPartHealth(EPABossPartType::Horn), 1500.0f, kPartTolerance);
		TestNearlyEqual(TEXT("AC1: Boss Total HP reduced to 9500"), Model.BossCurrentHealth, 9500.0f, kPartTolerance);
		TestNearlyEqual(TEXT("AC1: Horn HP percent is 75%"), Model.GetPartHealthPercent(EPABossPartType::Horn), 0.75f, kPartTolerance);
	}
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC2: Stun duration is 1.50s"), BreakResult.StunDuration, 1.50f, kPartTolerance);
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC3: Initial chest damage multiplier is 1.0"), Model.GetDamageMultiplier(EPABossPartType::ChestArmor), 1.0f, kPartTolerance);
		...
		TestNearlyEqual(TEXT("AC3: Multiplier is now 1.50x (+50%)"), Model.GetDamageMultiplier(EPABossPartType::ChestArmor), 1.50f, kPartTolerance);
		...
		TestNearlyEqual(TEXT("AC3: Weakpoint hit deals 150 damage (+50%)"), WeakpointHit.DamageDealtToBoss, 150.0f, kPartTolerance);
		TestNearlyEqual(TEXT("AC3: Boss HP reduced by exactly 150"), BossHPBefore - Model.BossCurrentHealth, 150.0f, kPartTolerance);
	}
