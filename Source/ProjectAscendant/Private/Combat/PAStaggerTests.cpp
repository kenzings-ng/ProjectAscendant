...
namespace
{
	constexpr float kStaggerTolerance = 0.05f;
...
bool FPAStaggerTests::RunTest(const FString& Parameters)
{
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC1: Initial Posture is 0"), Model.CurrentPosture, 0.0f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC1: Posture is 500"), Model.CurrentPosture, 500.0f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC1: Stagger time remaining is 3.0s"), Model.StaggerTimeRemaining, 3.0f, kStaggerTolerance);
	}
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC2: Deals exactly 25% True Damage (2500 HP)"), SuccessResult.DamageDealt, 2500.0f, kStaggerTolerance);
		TestNearlyEqual(TEXT("AC2: Grants 1.20s I-Frame"), SuccessResult.PlayerInvulnDuration, 1.20f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC2: Posture reset to 0"), Model.CurrentPosture, 0.0f, kStaggerTolerance);
		TestNearlyEqual(TEXT("AC2: Immunity time is 2.0s"), Model.ImmunityTimeRemaining, 2.0f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC2: Posture remains 0 during immunity"), Model.CurrentPosture, 0.0f, kStaggerTolerance);
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC3: Posture remains 400 before 4.0s delay"), Model.CurrentPosture, 400.0f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC3: TimeSinceLastDamage reset to 0"), Model.TimeSinceLastDamage, 0.0f, kStaggerTolerance);
		...
		TestNearlyEqual(TEXT("AC3: Posture frozen during new 4s delay"), Model.CurrentPosture, PostureBefore, kStaggerTolerance);
	}
	...
	// ===========================================================
	{
		...
		TestNearlyEqual(TEXT("AC4: Refunds exactly 50% Posture (400)"), Model.CurrentPosture, 400.0f, kStaggerTolerance);
