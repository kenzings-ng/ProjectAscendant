...
- [ ] **AC-1 (5 Vai Trò NPC Dân Sự & Rig Mapping)**:
  ...
  - Khởi tạo `UPACivilianNPCComponent` tự động gán đúng Master Rig theo thiết kế:
    - Thợ Rèn, Lính Gác $\rightarrow$ `EPAMasterRigType::HeavyTank`.
    - Thương Nhân, Dân Làng $\rightarrow$ `EPAMasterRigType::Agility` / `Caster`.
    - Quest Giver $\rightarrow$ `EPAMasterRigType::Caster`.
- [ ] **AC-2 (Dynamic Palette Swap Material)**:
...
- [ ] **AC-3 (Đạo Cụ Cầm Tay & Frame Callout Quest Giver)**:
...
- [ ] **AC-4 (Town Guard Outlaw Deterrence & Combat Reuse)**:
...
- [ ] **AC-5 (Headless Unit Tests Pass 100%)**:
