...
| Field | Value |
|-------|-------|
| **Engine Version** | Unreal Engine 5.8.2 |
| **Project Pinned** | 2026-09-17 |
...
> **Migration note (2026-09-17):** Project Ascendant now runs Unreal Engine 5.8.2
> (`ProjectAscendant.uproject` uses `EngineAssociation: "5.8"`). Most reference
> pages below remain historical UE 5.7 material and must be re-validated against
> UE 5.8.2 before being treated as authoritative.
